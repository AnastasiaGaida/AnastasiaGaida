<!-- Heading -->
<h3 align="center"><img src = "https://raw.githubusercontent.com/MartinHeinz/MartinHeinz/master/wave.gif" width = 30px> Привет! Меня зовут Анастасия</h2>
...
---
✨ Я начинающий аналитик данных. Увлекаюсь анализом данных и развиваюсь в этой сфере. Люблю анализировать и визуализировать данные и видеть результат своей работы. Использую Python для обработки и анализа данных, SQL для работы с базами данных,
